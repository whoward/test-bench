...
After reading the above documentation, you are ready to set up a project to use Test Bench. First, either install the +test_bench+ gem or add it to your project via e.g. Bundler. To install the gem:
